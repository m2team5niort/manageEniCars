            ...
            <div className="max-w-md w-full space-y-8">
                <div>
                    <img
                        ...
                        alt="Workflow"
                    />
                    <h2 className="mt-8 text-center text-3xl font-extrabold text-gray-900"> Je me connecte à mon compte </h2>
                ...
                <div className="flex flex-col items-center justify-between space-y-6">
                    {renderAuth ? (
                        <>
                            ...
                            >
                                <span className="w-full text-sm" onClick={loginWithEmailPassword}>
                                    Se connecter
                                </span>
                            </button>
                        </>
