    ...
    <div className='w-full bg-white py-16 px-4'>
      <div className='max-w-[1240px] mx-auto grid md:grid-cols'>
        <div className='flex flex-col justify-center'>
          ...
          <p className='text-lg font-bold'> A. Introduction </p>
          <p className='mt-2'> 1 - La confidentialité des visiteurs de notre site web est très importante à nos yeux, et nous nous engageons à la protéger. Cette politique détaille ce que nous faisons de vos informations personnelles. </p>
          <p className='mt-2'> 2 - Consentir à notre utilisation de cookies en accord avec cette politique lors de votre première visite de notre site web nous permet d’utiliser des cookies à chaque fois que vous consultez notre site. </p>

          <p className='text-lg font-bold mt-4'> B. Source</p>
          <p className='mt-2'>Ce document a été créé grâce à un modèle de SEQ Legal (seqlegal.com) et a été modifié par Website Planet (www.websiteplanet.com)</p>

          <p className='text-lg font-bold mt-4'> C. Collecte d’informations personnelles </p>
          <p className='mt-2'> Les types d’informations personnelles suivants peuvent collectés, stockés et utilisés : </p>
          <p className='mt-2'> 1 - Des informations à propos de votre ordinateur, y compris votre adresse IP, votre localisation géographique, le type et la version de votre navigateur, et votre système d’exploitation ; </p>
          <p className='mt-2'> 2 - Des informations sur vos visites et votre utilisation de ce site web y compris la source référente, la durée de la visite, les pages vues, et les chemins de navigation de sites web ; </p>
          <p className='mt-2'> 3 - Des informations comme votre adresse e-mail, que vous nous fournissez lors de votre inscription au site ; </p>
          <p className='mt-2'> 4 - Des informations que vous saisissez quand vous créez un profil sur notre site web comme votre nom, votre photo de profil, votre genre, votre date de naissance, votre situation amoureuse, vos intérêts et vos loisirs, votre parcours scolaire et votre parcours professionnel ; </p>
          <p className='mt-2'> 5 - Des informations comme votre nom et votre adresse e-mail, que vous saisissez pour souscrire à nos e-mails et/ou newsletters ; </p>
          <p className='mt-2'> 6 - Des informations que vous saisissez quand vous utilisez les services de notre site web ; </p>
          <p className='mt-2'> 7 - Des informations générées lors de l’utilisation de notre site, y compris quand, à quelle fréquence et sous quelles circonstances vous l’utilisez ; </p>
          <p className='mt-2'> 8 - Des informations relatives aux achats que vous faites, aux services que vous utilisez ou aux transactions que vous effectuez sur notre site, qui incluent votre nom, adresse, numéro de téléphone, adresse e-mail et informations bancaires ; </p>
          <p className='mt-2'> 9 - Des informations que vous publiez sur notre site web dans l’intention de les publier sur internet, et qui incluent votre identifiant, vos photos de profil et le contenu de vos publications ; </p>
          <p className='mt-2'> 10 - Des informations contenues dans toutes les communications que vous nous envoyez par e-mail ou sur notre site web, y compris leurs contenus et leurs métadonnées ; </p>
          <p className='mt-2'> 11 - Toute autre information personnelle que vous nous communiquez. </p>
          <p className='mt-2'>Avant de nous divulguer des informations personnelles concernant une autre personne, vous devez obtenir le consentement de ladite personne en ce qui concerne la divulgation et le traitement de ces informations personnelles selon les termes de cette politique </p>

          <p className='text-lg font-bold mt-4'> D. Utilisation de vos informations personnelles </p>
          <p className='mt-2'> 1 - Administrer notre site web et notre entreprise ; </p>
          <p className='mt-2'> 2 - Personnaliser notre site web pour vous ; </p>
          <p className='mt-2'> 3 - Permettre votre utilisation des services proposés sur notre site web ; </p>
          <p className='mt-2'> 4 - Vous envoyer les marchandises achetées sur notre site ; </p>
          <p className='mt-2'> 5 - Vous fournir les services achetés sur notre site ; </p>
          <p className='mt-2'> 6 - Vous envoyer des relevés, des factures et des rappels de paiement, et collecter vos paiements ; </p>
          <p className='mt-2'> 7 - Vous envoyer des communications commerciales non relatives au marketing ; </p>
          <p className='mt-2'> 8 - Vous envoyer des notifications par e-mail que vous avez expressément demandées ; </p>
          <p className='mt-2'> 9 - Vous envoyer notre newsletter par mail, si vous l’avez demandé (vous pouvez nous informer à tout moment de votre volonté de ne plus recevoir notre newsletter) ; </p>
          <p className='mt-2'> 10 - Vous envoyer des communications marketing relatives à notre entreprise ou à des entreprises tierces sélectionnées avec soin qui selon nous pourraient vous intéresser, sous forme de publication, ou si vous avez expressément donné votre accord, par e-mail ou technologie similaire (vous pouvez nous informer à tout moment de votre volonté de ne plus recevoir de communications marketing) ;  </p>
          <p className='mt-2'> 11 - Fournir des informations statistiques à propos de nos utilisateurs à des tierces parties (sans que ces tierces parties puissent identifier d’utilisateur individuel avec ces informations) ; </p>
          <p className='mt-2'> 12 - Traiter les demandes et les réclamations relatives à votre site web effectuées par vous ou vous concernant ; </p>
          <p className='mt-2'> 13 - Maintenir la sécurité de notre site web et empêcher la fraude ; </p>
          <p className='mt-2'> 14 - Vérifier le respect des conditions générales qui régissent l’utilisation de notre site web (y compris surveiller les messages privés envoyés par le biais du service de messagerie privé de notre site web) ;  </p>
          <p className='mt-2'> 15 - D’autres utilisations. </p>
          <p className='mt-2'> Si vous soumettez des informations personnelles sur notre site web dans le but de les publier, nous les publierons et pourrons utiliser ces informations conformément aux autorisations que vous nous accordez. </p>
          <p className='mt-2'> Vos paramètres de confidentialité peuvent être utilisés pour limiter la publication de vos informations sur notre site web et peuvent être ajustés dans vos paramètres de confidentialité sur le site web. </p>
          <p className='mt-2'> Sans votre consentement explicite, nous ne fournirons pas vos informations personnelles à des tierces parties pour leur marketing direct, ni celui d’autres tierces parties.</p>
...
Ce type de données personnelles sera supprimé  ; et
