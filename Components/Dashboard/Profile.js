                                ...
                                <div className="flex flex-col text-sm space-y-4">
                                    <div className='flex w-full space-x-4'>
                                        <div className='w-full space-y-2'>
                                            ...
                                            <input onChange={e => handleChange('lastName', e)} defaultValue={userState.lastName || ''} required='required' type="text" name="lastName" id="lastName" placeholder="Nom" className="w-full bg-gray-200 appearance-none relative block  px-3 py-2 placeholder-gray-500 text-gray-700 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" />
                                        </div>
                                    ...
                                    <div className='flex w-full space-x-4'>
                                        ...
                                        <div className="w-full space-y-2">
                                            ...
                                            <input onChange={e => handleChange('address', e)} defaultValue={userState.address || ''} required='required' type="text" name="address" id="address" placeholder="Adresse" className="bg-gray-200 appearance-none relative block w-full px-3 py-2 placeholder-gray-500 text-gray-700 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" />
                                        </div>
                                    ...
                                    <div className="w-full space-y-2">
                                        ...
                                        <input onChange={e => handleChange('country', e)} defaultValue={userState.country || ''} required='required' name="country" id="country" type="text" placeholder="Pays" className="bg-gray-200 appearance-none relative block w-full px-3 py-2 placeholder-gray-500 text-gray-700 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" />
                                    </div>
                                    ...
                                    <div className='flex w-full space-x-4'>
                                        ...
                                        <div className="w-full space-y-2">
                                            ...
                                            <input onChange={e => handleChange('departement', e)} defaultValue={userState.departement || ''} required='required' name="departement" id="departement" type="number" placeholder="Département" className="bg-gray-200 appearance-none relative block w-full px-3 py-2 placeholder-gray-500 text-gray-700 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" />
                                        </div>

                                        {/* Zip Code */}
                                        <div className="w-full space-y-2">
                                            <label htmlFor="zip">Code postal</label>
                                            <input onChange={e => handleChange('zip', e)} defaultValue={userState.zip || ''} required='required' name="zip" id="zip" type="number" placeholder="Code postal" className="bg-gray-200 appearance-none relative block w-full px-3 py-2  placeholder-gray-500 text-gray-700 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" />
                                        </div>
                                    </div>
