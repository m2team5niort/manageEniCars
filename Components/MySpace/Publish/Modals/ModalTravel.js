                                        ...
                                        <div className='flex flex-row'>
                                            <div className="flex flex-col justify-between space-y-4 pr-12 border-r-2 border-indigo-300">
                                                <div className='flex flex-row items-center'>
                                                    <OfficeBuildingIcon className='w-6 h-6 text-blue-500 mr-6'/>
                                                ...
                                                <div className='flex flex-row items-center'>
                                                    <FlagIcon className='w-6 h-6 text-blue-500 mr-6'/>
                                                    <div className='flex flex-col text-xs'>
                                            ...
                                            <div className='mx-auto'>
                                                ...
                                                <div className='flex flex-row justify-between items-center'>
                                                    <div className='flex flex-row ml-4'>
                                                        ...
                                                        <span className='border border-blue-200 mx-2'></span>
                                                        {travel.passengers ? 
                                                            <>
                                                            {travel.passengers.map(elem => (<Tooltip message={'Passager: '} userId={elem}><UserCircleIcon key={elem} className='w-8 h-8 text-blue-500' /></Tooltip>))}
                                            ...
                                            <button onClick={() => deleteTravel(travel)} className='px-4 py-2 text-sm bg-blue-500 rounded-md text-white mt-12'>Supprimer</button>
                                    </Dialog.Panel>
                                </Transition.Child>
                            </div>
                        </div>
