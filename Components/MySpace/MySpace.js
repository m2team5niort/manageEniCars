...
export default function MySpace({ssrDataMySpace}) {
    ...
    return (
        <div id="Container" className="bg-gray-50">
            <div className="container px-48 mx-auto space-y-12 py-20">
                <h1 className="text-5xl text-blue-800 font-semibold text-center">Publier, réserver un trajet avec Eni ManageCars</h1>
                <div className="w-full sm:px-0 space-y-6">
                    <Tab.Group>
                        <Tab.List className="flex w-full max-w-md space-x-1 rounded-xl bg-blue-900/20 p-1">
                            <div className='w-full max-w-md flex space-x-2 bg-blue-500 p-2 rounded-md'>
                                <Tab
                                    className={({ selected }) =>
                                        classNames(
