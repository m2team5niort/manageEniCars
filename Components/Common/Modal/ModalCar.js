export default function ModalCar({type, setFormData, formData, createCar, modal, setModal}){
                        ...
                        <form>
                            <div className='flex flex-col space-y-8 md:w-2/3 mx-auto py-8'>
                                <input
                                    ...
                                    placeholder={modal.nameInput.placeholder}
                                />
                                <input
                                    className='bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500'
                                    onChange={e => setFormData({ ...formData, 'description': e.target.value })}
                                    placeholder={modal.descriptionInput.placeholder}
                                />
                                <input
                                    className='bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500'
                                    onChange={e => setFormData({ ...formData, 'modele': e.target.value })}
                                    placeholder={modal.modelInput.placeholder}
                                />
                                <input
                                    className='bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500'
                                    onChange={e => setFormData({ ...formData, 'places': e.target.value })}
                                    placeholder={modal.placesInput.placeholder}
                                />
                            </div>
                            ...
                            <div className="flex items-center justify-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                                ...
                                <button onClick={createCar}  data-modal-toggle="defaultModal" type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Ajouter</button>
                            </div>
                        </form>
                    </div>
                </div>
